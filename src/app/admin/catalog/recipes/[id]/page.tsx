...
export default async function RecipeDetailPage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ mainError?: string }> }) {
  const { id } = await params;
  const { mainError } = await searchParams;
